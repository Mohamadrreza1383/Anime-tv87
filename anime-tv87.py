...
# 🔹 تنظیمات ربات
# -------------------------
BOT_TOKEN = "7968574879:AAFHH7bUWOjXc2heXVuBjtNT19XO9MZgp3E"  # ← توکن رباتت
ARCHIVE_CHANNEL_ID = -1003114976286  # ← آیدی کانال خصوصی
ADMIN_IDS = [5131647245]  # ← آیدی خودت برای حذف پیام‌ها
...
def save_to_channel(update: Update, context: CallbackContext):
    ...
    try:
        if msg.text:
            ...
            # عکس‌ها را با Pillow باز می‌کنیم و دوباره ارسال می‌کنیم
            ...
            out = io.BytesIO()
            image.save(out, format="PNG")  # ذخیره به فرمت PNG
            out.seek(0)
